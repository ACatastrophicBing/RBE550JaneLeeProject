...
if __name__ == "__main__":
    ...
    sim = Simulator(env, goal, rand_obstacles=20, wrld_size=wrld_size, num_humans=num_humans, global_map_init=args.dont_init_with_global_knowledge, c_space_dilation=0.1, use_global_knowledge=args.use_global_knowledge, visualize=visualize,map_selector=0)
    map = sim.map
    controller = None
